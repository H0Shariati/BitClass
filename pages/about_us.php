    ...
    <div class="container">
        <div class="row position-relative">
            ...
            <div class="col-lg-10 mx-auto text-center position-relative">
                ...
                <h1 class="fs-2">درباره آکادمی</h1>
                <p>ما ماموریت داریم دوره‌های جذاب و مدیریت‌شده را با قیمتی مناسب ارائه دهیم.</p>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 position-relative">
                ...
                <!-- Image -->
                <img src="files/pages/about-contact/<?php echo $info['about_image']; ?>" class="rounded" alt="">
            </div>

            <div class="col-lg-7 mt-4 mt-lg-0">
                <!-- Title -->
                <!-- Content -->
                <p><?php echo $info['full_about']; ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-light position-relative my-4">
    <!-- SVG Image -->
