        ...
        case 1:?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id order by update_date desc ";
        ...
        case 2:?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id order by course_price ";
                        $result_course = $link->query($sql);
                        if ($result_course->num_rows > 0) {
                            while($row_course = $result_course->fetch_assoc()) {?>
                                <div class="col-sm-6 col-lg-4 col-xl-3">
        ...
        case 3:?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id order by course_price desc ";
                        $result_course = $link->query($sql);
                        if ($result_course->num_rows > 0) {
                            while($row_course = $result_course->fetch_assoc()) {?>
                                <div class="col-sm-6 col-lg-4 col-xl-3">
