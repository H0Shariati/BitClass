...
if ($q != '') {
        ...
        case 'مقدماتی':?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id AND level='مقدماتی'";
                        ...
                        if ($result_course->num_rows > 0) {
                            ...
                            <div class=" text-center p-6 alert alert-danger mt-2"><br>منتظر دوره های جذاب ما باشید....</div>
                            <?php
                        }
                        ?>
                    </div>
        ...
        case 'متوسط':?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id AND level='متوسط'";
                        $result_course = $link->query($sql);
                        if ($result_course->num_rows > 0) {
                            while($row_course = $result_course->fetch_assoc()) {?>
                                <div class="col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div class=" text-center p-6 alert alert-danger mt-2"><br>منتظر دوره های جدید ما باشید....</div>
                            <?php
                        }
                        ?>
                    </div>
        ...
        case 'پیشرفته':?>
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row g-4">
                        <?php
                        $sql = "SELECT * FROM courses WHERE cat_id=$id AND level='پیشرفته'";
                        $result_course = $link->query($sql);
                        if ($result_course->num_rows > 0) {
                            while($row_course = $result_course->fetch_assoc()) {?>
                                <div class="col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div class=" text-center p-6 alert alert-danger mt-2">منتظر دوره های جدید ما باشید....</div>
                            <?php
                        }
                        ?>
                    </div>
    ...
    <div class="row mt-3">
        <div class="col-12">
            ...
            <div class="row g-4">
                <?php
                $sql = "SELECT * FROM courses WHERE cat_id=$id";
                $result_course = $link->query($sql);
                if ($result_course->num_rows > 0) {
                    while($row_course = $result_course->fetch_assoc()) {?>
                        <div class="col-sm-6 col-lg-4 col-xl-3">
