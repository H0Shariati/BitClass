...
<div class="row mt-3">
    <div class="col-12">
        ...
        <div class="row g-4">
            <?php
            $sql = "SELECT * FROM courses WHERE cat_id = '$q'";
            ...
            <?php
                ...
                <div class=" text-center p-6 alert alert-danger mt-2">برای این دسته بندی دوره ای ثبت نشده است!<br>منتظر دوره های جذاب ما باشید....</div>
                <?php
            }
            ?>
        </div>
