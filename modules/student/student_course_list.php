                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive border-0">
                            <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                                ...
                                <!-- Table item -->
                                <?php
                                $course=$link->query("SELECT courses.*,cart.status as price_status FROM cart join courses on cart.course_id=courses.id WHERE cart.user_id=".$_SESSION['login']." order by cart.id DESC");
