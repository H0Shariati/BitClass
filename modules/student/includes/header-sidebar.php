        ...
        <div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
            <div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
                ...
                <ul class="navbar-nav flex-column" id="navbar-sidebar">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="#"><i class="far fa-comment-dots fa-fw me-2"></i>دیدگاه ها</a></li>

                    <li class="nav-item"> <a class="nav-link" href="#"><i class="far fa-chart-bar fa-fw me-2"></i>درآمدها</a></li>

                    <li class="nav-item"> <a class="nav-link" href="#"><i class="fas fa-user-cog fa-fw me-2"></i>تنظیمات</a></li>
                ...
                <div class="px-3 mt-auto pt-3">
                    <div class="d-flex align-items-center justify-content-between text-primary-hover">
                        ...
                        <a class="h5 mb-0 text-body" href="index.php" data-bs-toggle="tooltip" data-bs-placement="top" title="صفحه اصلی">
